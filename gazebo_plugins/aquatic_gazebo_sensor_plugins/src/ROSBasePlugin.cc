...
#include <aquatic_gazebo_sensor_plugins/ROSBasePlugin.hh>
...
bool ROSBasePlugin::InitBasePlugin(sdf::ElementPtr _sdf)
{
  ...
  // Get the update rate
  GetSDFParam<double>(_sdf, "update_rate", this->updateRate, 10.0);
...
bool ROSBasePlugin::ChangeSensorState(
    aquatic_gazebo_sensor_plugins_msgs::ChangeSensorState::Request& _req,
    aquatic_gazebo_sensor_plugins_msgs::ChangeSensorState::Response& _res)
{
